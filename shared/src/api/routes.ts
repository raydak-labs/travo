...
export const API_ROUTES = {
  ...
  system: {
    ...
    speedtestServiceInstall: '/api/v1/system/speedtest-service/install',
    speedtestServiceUninstall: '/api/v1/system/speedtest-service/uninstall',
    speedtestServiceRun: '/api/v1/system/speedtest-service/run',
  ...
  network: {
    ...
    firewallZones: '/api/v1/network/firewall/zones',
    portForwards: '/api/v1/network/firewall/port-forwards',
  ...
  wifi: {
    ...
    schedule: '/api/v1/wifi/schedule',
    macPolicies: '/api/v1/wifi/mac-policies',
  },
  vpn: {
  ...
  adguard: {
    ...
    dnsMode: '/api/v1/adguard/dns-mode',
  },
} as const;
